...
class ExampleSignalTest(unittest.TestCase):
    ...
    def test_load_txt(self):
        ...
        self.assertEqual(self.test_raw.info['ch_names'],['ch0'])
        print('important number to be noticed `(*>﹏<*)′')
...
#         self.assertEqual(new_raw.get_data().all(),self.test_raw.get_data().all())
    ...
    def test_filter_by_freq(self):
        ...
        psds_high, frqs_high = mne.time_frequency.psd_multitaper(test_epochs_copy, fmin=29, fmax=50, tmin=None, tmax=None)
        ...
        psds_high_after, frqs_high_after = mne.time_frequency.psd_multitaper(epochs_filtered, fmin=29, fmax=50, tmin=None, tmax=None)
